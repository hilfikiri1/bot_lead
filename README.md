...
| **Внешняя запись** | Kommo, Notion, Drive, Gmail, Calendar, Sheets | Обязательный preview и подтверждение; исключение — подписанный intake формы сайта |
...
- Произвольные изменения Kommo, Notion, Drive, Calendar и Sheets выполняются только после подтверждения. Подписанный `website-form` webhook — узкое заранее разрешённое исключение: он детерминированно создаёт только исходный контакт/лид Kommo и не пишет AI-сгенерированные данные.
