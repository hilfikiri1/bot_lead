...
class Settings(BaseSettings):
    ...
    database_url: str = Field(default="postgresql+asyncpg://postgres:postgres@db:5432/catalog_bot", alias="DATABASE_URL")
    ...
    brand_logo_path: str = Field(default="app/catalog/static/logo.png", alias="BRAND_LOGO_PATH")
    ...
    playwright_storage_state: str = Field(default="storage/browser/1688_storage_state.json", alias="PLAYWRIGHT_STORAGE_STATE")
    ...
    storage_temp_dir: Path = Path("storage/temporary")
    storage_output_dir: Path = Path("storage/output")
