...
class CatalogJob(Base):
    ...
    status: Mapped[str] = mapped_column(String(32), nullable=False, default=JobStatus.RECEIVED.value)
    ...
    def is_active(self) -> bool:
        return self.status not in (JobStatus.COMPLETED.value, JobStatus.FAILED.value)
