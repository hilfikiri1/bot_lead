...
class ParsedProduct(BaseModel):
    ...
    def has_minimum_data(self) -> bool:
        return bool(self.source_url and self.title_zh and (self.gallery_image_urls or self.detail_image_urls or self.local_image_paths))


class ValidatedProductUrl(BaseModel):
    original_url: str
    final_url: HttpUrl
